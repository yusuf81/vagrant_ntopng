...
# Dependencies
apt-get install -y build-essential libsqlite3-0 libgeoip1 redis-server librrd4 libhiredis0.13 libcurl3 gdb
apt-get install -y libtool autoconf automake subversion rrdtool wget pkg-config git perl
